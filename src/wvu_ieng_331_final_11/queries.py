...
def get_delivery_time(
    ...
    """
    Executes the delivery time query against DuckDB and returns a Polars DataFrame.
    ...
    Returns:
        pl.DataFrame: A Polars DataFrame containing shipping delay metrics.
    ...
    sql_file = SQL_DIR / "DeliveryTime.sql"
